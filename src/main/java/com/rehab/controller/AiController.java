...
public class AiController {
	...
	@Operation(
		summary = "AI 운동 추천",
		description = "사용자의 현재 상태를 기반으로 AI가 적합한 운동을 추천합니다."
	)
	...
	@Operation(
		summary = "AI 회복 예측",
		description = "사용자의 현재 상태와 순응도를 기반으로 회복 경과를 예측합니다."
	)
	...
	@Operation(
		summary = "AI 추론 로그 조회",
		description = "사용자의 AI 추론 이력을 조회합니다."
	)
